...
class TestNetGauss:
    ...
    def test_convert_params0_to_params(self):
        ...
        x_out_true = {
            ...
            "chol": np.array([
                [ 3.874435 ,  0.       ,  0.       ,  0.       ,  0.       ],
                [ 8.809233 ,  9.047774 ,  0.       ,  0.       ,  0.       ],
                [ 3.9170508,  6.8248806,  8.244412 ,  0.       ,  0.       ],
                [-3.0690994, -3.0690994, -3.0690994, -5.029117 ,  0.       ],
                [ 0.       , -3.0690994, -3.0690994, -6.029127 , -5.029117 ]
            ])
        }
    ...
    def test_params0_to_nmoments(self):
        ...
        x_out_true = {
            "mu": np.array([10., 8., 4., -3.31234, -3.31234]),
            "ncov": np.array([
                [100.178925 ,  79.95931  ,  39.960938 , -33.107113 , -33.151295 ],
                [ 79.95931  ,  64.024414 ,  32.023438 , -26.474775 , -26.502554 ],
                [ 39.960938 ,  32.023438 ,  16.0625   , -13.217458 , -13.2544775],
                [-33.107113 , -26.474775 , -13.217458 ,  11.067951 , 10.924188 ],
                [-33.151295 , -26.502554 , -13.2544775,  10.924188 , 11.0111265]
                ])
        }
